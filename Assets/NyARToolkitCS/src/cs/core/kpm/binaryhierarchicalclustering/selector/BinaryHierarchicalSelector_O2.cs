...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    public class BinaryHierarchicalSelector_O2
    {
        ...
        readonly public FreakMatchPointSetStack.Item[] _result;
        readonly private LimitedPriorityNodeList mlist;
        //特徴量の一時バッファ
        readonly private NodeStack _node_stack = new NodeStack(1000);
