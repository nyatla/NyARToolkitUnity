...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    public class BinaryHierarchicalNode
    {
        ...
        // Feature center
        readonly public FreakFeaturePoint center;

        // True if a leaf node
        readonly public bool is_leaf;

        // Child nodes
        readonly public BinaryHierarchicalNode[] children;

        // Index of the features at this node
        readonly public FreakMatchPointSetStack.Item[] reserv_index;
