...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    {
        private const double ONE_OVER_2PI = 0.159154943091895;
        private const double PI = NyARMath.PI;
        readonly private double[] mHistogram;
         ...
         */
        private static bool Quadratic3Points(double[] r,
                double[] p1,
                double[] p2,
                double[] p3)
        {
         ...
         */
        private static bool QuadraticCriticalPoint(double[] x, double A, double B, double C)
        {
            if (A == 0)
            {
                return false;
