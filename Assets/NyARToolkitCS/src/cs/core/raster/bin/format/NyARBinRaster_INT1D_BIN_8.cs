...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    public class NyARBinRaster_INT1D_BIN_8 : NyARBinRaster
    {
        protected int[] _buf;
        public NyARBinRaster_INT1D_BIN_8(int i_width, int i_height, bool i_is_alloc):base(i_width, i_height, i_is_alloc)
        {
