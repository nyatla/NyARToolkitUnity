...
namespace jp.nyatla.nyartoolkit.cs.core
{
     ...
     *
     */
    public class NyARTemplateMatchingDriver_INT1D : INyARTemplateMatchingDriver
    {

        readonly private INyARGrayscaleRaster _i_ref_raster;
        readonly private byte[] _mbuf;
        /**
        ...
        public const int SKIP_INTERVAL = 3;
        public const int KEEP_NUM = 3;
        ...
        readonly private NyARIntPoint2d _search_area = new NyARIntPoint2d();
        ...
        private class MatchingCandidateList
        {
             ...
             */
            public bool tryToAdd(int i_x, int i_y, int i_val)
            {
