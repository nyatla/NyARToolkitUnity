...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    {
        public const int AR2_TEMP_SCALE = 2;
        public const int AR2_TEMPLATE_NULL_PIXEL = 2000000000;
        /**
         * テンプレートサイズ
         */
         ...
         * xsize=xts*2+1
         */
        readonly public int xts;
        /**
         * y方向のテンプレート領域
         * ysize=yts*2+1
         */
        readonly public int yts;
        /**
         * テンプレートイメージ。この値はARToolkitNFTと異なり、生データであるので注意すること！
         */
        readonly public int[] img;
        /**
        ...
        readonly private NyARDoublePoint2d __in = new NyARDoublePoint2d();
